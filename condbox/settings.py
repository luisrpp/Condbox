...
SECRET_KEY = '1o2pn0(-s205h1^fj$=y$-nqi8%-$a8aa*l5ox77ud(04!+a=c'
...
ROOT_URLCONF = 'condbox.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'condbox.wsgi.application'
...
DEFAULT_FROM_EMAIL = 'condbox@condbox.com.br'
